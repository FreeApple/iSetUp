...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
     ...
     self.homeView = [[[HomeViewController alloc] initWithNibName:@"HomeViewController" bundle:nil] autorelease];
    
    controller=[[UINavigationController alloc] initWithRootViewController:self.homeView];
	...
	if(textValue == nil)
	{
        ...
        for(item in preferencesArray)
		{
			...
			if([keyValue isEqualToString:@"appSounds"])
				AppSounds = defaultValue;
		...
		NSDictionary *appPrerfs = [NSDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   [NSNumber numberWithInt:1], @"appSounds",
								   nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"iSetUp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"iSetUp.sqlite"];
